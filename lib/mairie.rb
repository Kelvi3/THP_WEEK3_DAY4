...
def scrapper
    return doc = Nokogiri::HTML(URI.open('https://www.annuaire-des-mairies.com/val-d-oise.html'))
 end
...
def city_mail
    array_name = []
    array_mail = []
    page_city = Nokogiri::HTML(URI.open("http://annuaire-des-mairies.com/40/mont-de-marsan.html"))
